...
export const articles: Article[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: {
          el: 'Το παρακάτω γράφημα δείχνει τη σύνθεση των εκπομπών αερίων θερμοκηπίου της Ελλάδας ανά τύπο αερίου [1]. Παρότι το CO₂ κυριαρχεί σε όγκο, τα υπόλοιπα αέρια \u2014ιδίως το μεθάνιο\u2014 ζυγίζουν δυσανάλογα λόγω του πολύ υψηλότερου δυναμικού υπερθέρμανσής τους.',
          en: 'The chart below shows the composition of Greece\'s greenhouse gas emissions by gas type [1]. Although CO₂ dominates by volume, the remaining gases\u2014particularly methane\u2014carry disproportionate weight due to their much higher warming potential.',
        },
      ...
      },
      {
        ...
        body: {
          el: 'Τα φθοριούχα αέρια, που χρησιμοποιούνται κυρίως στην ψύξη και τον κλιματισμό, υπάρχουν σε ελάχιστες φυσικές ποσότητες. Ωστόσο, με τιμές GWP που φτάνουν τις χιλιάδες, ακόμη και μικρές διαρροές από βιομηχανικά συστήματα ψύξης ή απορριφθέντα οικιακά κλιματιστικά προσθέτουν ένα σημαντικό ~5,7% στο σύνολο των εκπομπών [1].',
          en: 'Fluorinated gases, used primarily in refrigeration and air conditioning, exist in tiny physical quantities. However, with GWP values in the thousands, even small leaks from industrial cooling systems or discarded household AC units add a significant ~5.7% to total emissions [1].',
        },
      },
      {
        heading: {
        ...
        body: {
          el: 'Η αποτελεσματική παρακολούθηση των εκπομπών σημαίνει παρακολούθηση όλων των αερίων, όχι μόνο αυτών που βγαίνουν από τις εξατμίσεις. Ενώ η απαλλαγή του ενεργειακού δικτύου από τον άνθρακα και ο εξηλεκτρισμός των μεταφορών (με στόχο το CO₂) παραμένει η νούμερο ένα προτεραιότητα, η επίτευξη πραγματικών καθαρών μηδενικών εκπομπών θα απαιτήσει τον εκσυγχρονισμό της διαχείρισης αποβλήτων (για τη δέσμευση του βιοαερίου) και την υιοθέτηση πιο έξυπνων γεωργικών πρακτικών με χαμηλότερες εκπομπές [3].',
    ...
    sources: [
      { name: '[1] Emission-Index.com \u2014 Greece GHG Profile (2021)', url: 'https://www.emission-index.com/countries/greece' },
